...
function LeftHand() {
    ...
    return (
        <div className="left">
            ...
            <Link className={`page icon ${location.pathname === "/airtimeData" || location.pathname === "/Airtime" || location.pathname === "/Data" ? "active" : ""}`} to="/airtimeData"><i className="fa-solid fa-mobile"></i> mobile</Link> <br />
